...
- Maintain a conventional Course guide with audience, prerequisites, canonical course identity/outcomes, weekly workload, dated timetable, assessment links, preparation, accessible routes and routed help. Derive dates, weights and staff identities from existing records. Keep six academic primary links: Overview, Course guide, Weeks, Labs, Assessments and People. Place course purpose, audience, outcomes, study format and assessment before demonstrations or game entry on the homepage. Keep the academy and final mission accessible through study guidance and secondary navigation. Do not invent live staff contacts, enrolment services, credit approval or unassigned appointment times.
...
- Support wheel zoom over the scene and zoom buttons. Fullscreen starts with the cursor free and click-and-drag turning. Only X or the labelled Lock cursor toggle enables mouse-look; X again or Tab releases it for panel scrolling and choices. Ordinary scene clicks never recapture it. Ignore X in editable fields, on key repeat and with command modifiers. Escape leaves fullscreen. Preserve drag/touch and keyboard alternatives. Browser permission denial must retain a usable full-window layout.
