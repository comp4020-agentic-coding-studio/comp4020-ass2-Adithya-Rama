...
export const demonstrations:Demonstration[] = [
  {
    ...
    "transfer": "The assigned scene asks you to select a follow-up check for a different claim; the tray-check record here cannot answer it.",
  ...
  },
  {
    ...
    "transfer": "Your lists and associations differ. Explain when notes outperform deliberate recall instead of treating memorisation as compulsory.",
    ...
    "steps": [
      ...
      },
      {
        ...
        "narration": "The supported result is a change from two correctly recalled items to four in one guided trial, with a later substitution. The demonstrator reports that result without promising permanent photographic memory. The next dispatch permits a written list and requires exact checking by another person. The demonstrator chooses a carried checklist with read-back; the earlier mnemonic remains useful if the list is temporarily unavailable.",
        "why": "Practice, cue quality and material familiarity can all affect a small comparison. A memory technique is a tool to choose, not a rule that prohibits external records.",
        ...
        "controls": [
          ...
          {
            "id": "method",
            "label": "Next task: a safety-critical kit list may be carried on paper",
            "type": "select",
            "initial": "",
            "expected": "Written checklist with receiver read-back",
            "options": [
              {
                "value": "Written checklist with receiver read-back",
                "label": "Written checklist with receiver read-back"
              },
              {
                "value": "Rely on the successful memory trial alone",
                "label": "Rely on the successful memory trial alone"
              },
              {
                "value": "Repeat the list silently and discard the record",
                "label": "Repeat the list silently and discard the record"
              }
            ]
          }
        ],
        ...
        "success": "The completed record explains a strategy, its measured use and its limits. For the new dispatch, the written checklist makes the list inspectable by the receiver and avoids depending on unaided recall.",
  ...
  },
  {
    ...
    "transfer": "The assigned connector begins with a different pair of labelled ports and its changed target needs a different transformation.",
  ...
  },
  {
    ...
    "transfer": "The assigned driver, readiness state and changed output differ. Inspect the state before copying a sequence of repairs.",
    ...
    "steps": [
      ...
      },
      {
        ...
        "narration": "The ratio is correct, but the cam cannot move while the interlock is engaged. The demonstrator stops trying to rotate it and releases the interlock. The demonstrator separates two explanations: the transmission ratio can be correct while a physical interlock prevents movement. Inspecting that dependency is more informative than replacing a gear.",
        "why": "A readiness fault and a ratio fault require different corrections. A useful diagnostic action has different implications for competing causes.",
        ...
        "controls": [
          ...
          {
            "id": "test",
            "label": "The ratio is correct but the cam cannot move: what distinguishes the cause?",
            "type": "select",
            "initial": "",
            "expected": "Inspect the interlock state before changing gears",
            "options": [
              {
                "value": "Inspect the interlock state before changing gears",
                "label": "Inspect the interlock state before changing gears"
              },
              {
                "value": "Install a larger gear immediately",
                "label": "Install a larger gear immediately"
              },
              {
                "value": "Assume the target ratio is wrong",
                "label": "Assume the target ratio is wrong"
              }
            ]
          }
        ],
  ...
  },
  {
    ...
    "transfer": "This example has two simultaneous faults; the assigned model has one. Use its observed trace, not this cable-and-lamp answer.",
  ...
  },
  {
    ...
    "transfer": "The assigned archive uses different completeness and reference conditions. A later file can still be the wrong deliverable.",
  ...
  },
  {
    ...
    "transfer": "The assigned role policy grants different read rights. Copying this completed matrix would apply the wrong authority.",
  ...
  },
  {
    ...
    "transfer": "The assigned roles hold different fields; the receiver must supply its own access condition. A confirmed example message cannot authorise it.",
  ...
  },
  {
    ...
    "transfer": "Your council has different capacity and mandate constraints. More than one agreement may be feasible; state what your terms cost each role.",
    ...
    "steps": [
      ...
      },
      {
        ...
        "narration": "The council records a proposed handover of the original to Mira on the certified cart, with Ada retaining the custody record and a return commitment. Copy-only delivery cannot serve the original provenance examination. Nothing has been dispatched yet. Two agreements are feasible under the first brief: send a verified copy while Ada keeps the original, or lend the supported original with a named return condition. Mira prioritises examining the original; Ada accepts temporary custody with recorded return. The demonstrator chooses the latter and records its greater handling obligation.",
        "why": "A feasible plan still needs an authorised recipient and a recorded custody condition. Feasibility alone does not select between legitimate interests. The later remote-access brief removes the reason to incur physical handling.",
        ...
        "controls": [
          ...
          {
            "id": "tradeoff",
            "label": "A verified copy also meets access needs: why choose physical handover here?",
            "type": "select",
            "initial": "",
            "expected": "Mira requests physical provenance inspection and Ada accepts a recorded return",
            "options": [
              {
                "value": "Mira requests physical provenance inspection and Ada accepts a recorded return",
                "label": "Mira requests physical provenance inspection and Ada accepts a recorded return"
              },
              {
                "value": "Moving the original is always academically superior",
                "label": "Moving the original is always academically superior"
              },
              {
                "value": "The first feasible option needs no comparison",
                "label": "The first feasible option needs no comparison"
              }
            ]
          }
        ],
        ...
        "success": "The first agreement satisfies objective, capacity and custody. Its status is a prepared plan, not a completed delivery. A verified copy was also feasible for research access. The selected original loan serves the stated provenance priority and accepts a handling and return obligation.",
  ...
  },
  {
    ...
    "transfer": "The assigned map and objective differ. Recompute the relevant count or route cost before selecting an approach.",
    ...
    "steps": [
      ...
      },
      {
        ...
        "narration": "For a training objective of checking the detector, the three-contact route may be useful. For minimising recorded contact, the first route now has zero. The demonstrator states the objective before choosing. A survey brief then asks for confirmation that three marked sensors respond. Under that objective, a route with three predicted and observed contacts supplies better evidence than a zero-contact route. The preferred route depends on the job.",
        ...
        "controls": [
          ...
          {
            "id": "criterion",
            "label": "Changed scenario: each marked-cell contact confirms a functioning sensor; the task is to verify three sensors",
            "type": "select",
            "initial": "",
            "expected": "Choose the three-contact route and compare its trace",
            "options": [
              {
                "value": "Choose the three-contact route and compare its trace",
                "label": "Choose the three-contact route and compare its trace"
              },
              {
                "value": "Always choose the route with zero contacts",
                "label": "Always choose the route with zero contacts"
              },
              {
                "value": "Ignore the sensor results once the destination is reached",
                "label": "Ignore the sensor results once the destination is reached"
              }
            ]
          }
        ],
        ...
        "success": "The output demonstrates a model and its transfer to changed conditions. Under the sensor-verification brief, the three-contact trace establishes the required coverage; zero contacts would leave the sensors untested.",
  ...
  },
  {
    ...
    "transfer": "This example changes authority while leaving equipment intact. Your disruption concerns availability and needs different replacement evidence.",
  ...
  },
  {
    ...
    "transfer": "The rainfall case has a different item and custody arrangement. Your final approach determines its own required checks.",
  ...
  },
  {
    ...
    "transfer": "Use your actual attempts. The authored portfolio demonstrates selection and traceability, not personal evidence you can submit.",
  ...
  },
  {
    ...
    "transfer": "The botanical mechanism needs different gearing, orientation and readiness. Its memory rehearsal illustrates a strategy, not a mandatory gate in your assigned trial.",
  ...
  },
  {
    ...
    "transfer": "Iris has a load fault and an amended calibration deliverable; the assigned relay requires its own source and receiver checks.",
  ...
  },
  {
    ...
    "transfer": "Lamplight first tests physical recovery, then uses a portable digital carrier. Last Light offers terminal transmission, physical carriage or supported handover; select only the checks your chosen approach actually needs.",
    ...
    "steps": [
      ...
      },
      {
        ...
        "narration": "The team account explains both rehearsals, preserved plans, individual contributions and the choice to deliver a copy. The original still needs a future supported handover if physical provenance work is required; scientific accuracy remains a separate question. The team distinguishes the baseline physical rehearsal from the revised digital run. It does not repeat the unavailable original cradle test as a gate for the lightweight carrier. Its current source, carrier route, recipient receipt and preserved-original custody still need evidence.",
        "why": "A complete recovery account includes consequences and credible alternatives, not only a success label. A justified omission states why a check is irrelevant to this approach; it does not waive a dependency that still applies.",
        ...
        "controls": [
          ...
          {
            "id": "omission",
            "label": "Why does the revised digital carrier not need the original’s withdrawn cradle?",
            "type": "select",
            "initial": "",
            "expected": "The supported original stays with Quill; the lightweight carrier uses its own handling and route evidence",
            "options": [
              {
                "value": "The supported original stays with Quill; the lightweight carrier uses its own handling and route evidence",
                "label": "The supported original stays with Quill; the lightweight carrier uses its own handling and route evidence"
              },
              {
                "value": "Every studied capability must be repeated in every final approach",
                "label": "Every studied capability must be repeated in every final approach"
              },
              {
                "value": "A digital ending requires no verification",
                "label": "A digital ending requires no verification"
              }
            ]
          }
        ],
