...
teachers: ["mara-voss"]
date: 2027-03-12
checkpointDue: 2027-03-12T17:00:00+11:00
produces: ["spatial-model"]
requires: ["recall-strategy"]
sampleAvailable: true
campusPack: "/campus/week-03.md"
browserActivity: "/sessions/week-03/#activity"
assessmentIds: ["fieldwork", "assignment-1"]
related: ["lectures/week-03", "assessments/assignment-1", "assessments/fieldwork"]
spec:
...
**Activity:** Students construct using two views and ask for the third only after stating what it would resolve. For a nonvisual route, give coordinate lists and use tactile blocks or verbal position descriptions.
...
**Worked reflection:** I predicted north would become south after two clockwise quarter-turns. I then moved the connector to level 1 without changing its orientation and checked both conditions.
...
What extra view removed uncertainty, and which assumption did it test?
