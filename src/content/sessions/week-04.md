...
produces: ["mechanism-diagnosis"]
requires: ["spatial-model"]
sampleAvailable: true
campusPack: "/campus/week-04.md"
browserActivity: "/sessions/week-04/#activity"
...
**Activity:** Students predict movement before the facilitator operates the model. Change a single fault between trials. Keep hands away from moving contact points and operate only low-force paper/card parts. Record theoretical predictions separately from imperfections in the constructed model.
...
Which observation would have disproved your first diagnosis?
