...
- **Observation:** a detail you can directly see or measure. “The door is open.”
- **Claim:** an account supplied by a person or document. “I left first,” written by the note's author. The account may be true, but the note alone does not verify it.
- **Inference:** an explanation drawn from other information. “The owner left in a hurry.” An open door does not establish that cause.

Seeing that a note exists is an observation. The story written on it is the claim being classified. **Inspect** means select a named object and read its revealed detail. This lab asks you to observe and classify; it does not ask you to repair equipment.
