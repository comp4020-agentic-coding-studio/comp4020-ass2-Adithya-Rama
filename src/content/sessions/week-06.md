...
produces: ["evidence-timeline"]
requires: ["circuit-diagnosis"]
sampleAvailable: true
campusPack: "/campus/week-06.md"
browserActivity: "/sessions/week-06/#activity"
assessmentIds: ["fieldwork", "assignment-2"]
related: ["lectures/week-06", "assessments/assignment-2", "assessments/fieldwork"]
spec:
...
Read the [briefing](/lectures/week-06/). All starting rules and data are supplied here, so you can begin directly even if you missed an earlier lab. For the preferred in-person route, read the [campus pack](/campus/week-06.md). The online route is available when you cannot attend. Both assess the outcomes below.
...
**Equipment:** Printed evidence cards or the downloadable text pack, a blank timeline and coloured markers with text labels. No external account or live system is involved.
