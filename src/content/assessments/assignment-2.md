...
3. **Inspect mission station** to establish the relay problem. Select **Systems Specialist** and **Power bay**. Select **Measure supply and fuse** before replacing anything. Keep the load switch open while changing the fuse, then close it and check the result.
...
6. Check the **Mission Journal** for the four relay objectives. Visit **Dispatch** and **Transmit the verified relay record** at the field console. Collect the receiving acknowledgement, visit **Check the receiving terminal**, then deliver that acknowledgement to the receiving point. Only then select **Finish relay trial** and **Export assessment record**. Preserve the initial checkpoint separately.
