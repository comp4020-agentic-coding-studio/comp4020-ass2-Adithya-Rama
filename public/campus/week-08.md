# SLOP4408 — Week 8: Get the Message Through
...
Separate analyst and operator cards, blank handoff forms and a shared dispatch token. Spoken, written or typed messages are equally valid.

## Facilitator setup

Print separate analyst cards for Relay/2/AMBER, Archive/3/COPPER and Dispatch/1/IVORY. Give the operator a blank three-field form and acknowledgement box.
