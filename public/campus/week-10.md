# SLOP4408 — Week 10: Move Through the Model
...
A 5×5 printed grid, a player counter, four sensor markers, route arrows and a prediction sheet.

## Facilitator setup

Draw a 5×5 grid, mark start and destination, and highlight the published sensor cells for the chosen phase. Keep all cells and rules visible.
